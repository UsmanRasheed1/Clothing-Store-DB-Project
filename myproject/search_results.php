...
if (isset($_GET['email']) && isset($_GET['searchitem'])) {
    $email = $_GET['email'];
    ...
    $queryClothes = "SELECT clothesId, clothes_Name, picture, price FROM clothes WHERE clothes_Name like '%$searchitem%' order by price asc";
...
<head>
    ...
    <title>Display Winter's Clothing Items</title>
    <style>
        .item {
...
<header>
    ...
    ?>
    <h2>Search Results for <?php echo htmlspecialchars($searchitem); ?></h2>
    <?php
