...
if (isset($_GET['email'])) {
    ...
    // Query to fetch user's first and last name based on userId
    ...
    $queryClothes = "SELECT clothesId, clothes_Name, picture, price FROM clothes WHERE category='women' order by price asc";
...
.item {
    ...
    padding: 10px;
    border-radius: 8px;
    background-color: #f3f3f3; /* Background color for each item block */
...
<header>
        ...
        &nbsp; &nbsp; &nbsp;
        <a href="men.php?email=<?php echo $email; ?>" target="_main" class="account"> Women</a>
        &nbsp; &nbsp; &nbsp;
